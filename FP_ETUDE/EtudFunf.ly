...
rechtsFive = \relative {
  ...
  <fis,! fis'!>8-> <fis fis'>16-> q->
  \times 2/3 {q8-> q-> q->} q8-> q->
  \break
  q2-^ <g e' g>4->
  ...
  \repeat tremolo 6 {c' c,}<h h'>8->) r r2
  \repeat tremolo 6 {a'16^( dis,}
  \repeat tremolo 6 {a' d,!)}
  \break
  ...
  \clef treble
  gis16-- h-- e-- gis~ \afterGrace gis!2.
  \startTrillSpan {fis16[(\stopTrillSpan gis]} a4)
  \clef bass
  ...
  <<
    {      
      \stemDown
      fis-- a-- dis-- fis~\afterGrace fis!2.\startTrillSpan {
        \stemUp eis16[_(\stopTrillSpan fis]
      }
      %\stemUp
    ...
    \\
    {
      s4 s2. r4 <gis h><a cis><h dis><cis e>2 d4 <g, h><a cis>
      <h d>< cis e>2 <g b>4<a c!>2<f b>4<fes g>2 <es as>2.
    }
  >>
  R2.*2
  \clef bass
  ...
  \repeat tremolo 6 {a' d,!}
  \repeat tremolo 6 {b' cis,}
  \repeat tremolo 2 {h'! h,}
  \repeat tremolo 4 {gis' gis'}
  \repeat tremolo 4 {g,! g'}
  \repeat tremolo 2 {d d'}
  c, c' des, des'
  \clef treble
  f, f' a, a' c, c' f, f')
  <as, c as'>2.<fes' ces' fes>4<f b f'>2<des b' des>2.
  <<
    {
      b'2
    }
  ...
  dis' dis, cis' cis, h' h, a' a, g' g, f' f, 
  <g h dis>4-^<dis'' a' c dis>2->
  \clef bass
  \repeat tremolo 6 {a,,16^( dis,}
  \repeat tremolo 6 {a' d,!}
  \repeat tremolo 4 {b' cis,} b' f b f')
  ...
  >>
  <a f'>4<b g'><c a'><fis! a>2.<g b><fis a>~ q2 r4 R2.
  <fis a>->(<g b><fis a>)
  \repeat unfold 2 {\repeat tremolo 6 {d16 e}}
  \once \override Hairpin.extra-offset = #'(1 . 7.7)
  \repeat tremolo 6 {cis-^\> e\!}
  \repeat tremolo 2 {h d}
  \repeat tremolo 2 {c es}
  \repeat tremolo 2 {cis e}
  \repeat tremolo 2 {d f}
  \repeat tremolo 2 {dis fis}
  <<
    {
...
dynamicFive = {
  ...
  s2.*3\< s2\sf\> s4\p s2.\< s2\sf\> s4\pp s2.*2 s4.
  ...
  s2.*2\ppp
  s4. s4.\< s2.\> s4 s2\p s4. s4.\< s2.\> s4 s2\p
  s4. s4.\< s2.\> s2 s4\!
  s2\< s4\! s2\> s4\! s2\< s4\! s2\> s8 s8\! s2
  s4^\markup {\italic dim} s2.*2
  s2\sf\> s8 s8\pp s2 s4\< s2. s2 s4\!
  s4\f s2\< s4 s2\> s4 s4\< s8. s16\!
  ...
  \once \override DynamicText.extra-offset = #'(0.5 . 0)
  s2\mp s4^\markup {\italic cresc} s2. s2.\ff\> s2 s8 s8\mp
  s2\sf\> s4\pp
}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
linksFive = \relative {
  ...
  e, e' dis, dis' d, d' dis, dis' e, e' f, f' 
  fis, fis' g, g' gis, gis' a, a' b, b' h, h'
  c, c' cis, cis' 
  ...
  \repeat tremolo 6 {h-^ h'}
  \repeat tremolo 2 {h, h'}
  \repeat tremolo 4 {b, b'}
  a, a' e e' a, a' cis, cis' e, e' a, a'
  \clef treble
  \repeat tremolo 4 {h, h'}
  \repeat tremolo 2 {a, a'}
  \repeat tremolo 6 {e e'}
  \repeat tremolo 6 {dis, dis'}
  \repeat tremolo 6 {d, d'}
  \clef bass
  \repeat tremolo 6 {b,, b'}
  b, b' a, a' as, as' g, g' fis, fis' f, f'
  e, e' dis, dis' d, d' cis, cis' c, c' h, h'
  b, b' a, a' as, as' g, g' fis, fis' f, f'
  \repeat tremolo 6 {e,-^ e'}
  ...
  >>
  \repeat tremolo 6 {e,16 e'}
  \repeat unfold 10 {\repeat tremolo 6 {dis, dis'}}
  dis, dis' d, d' cis, cis' c, c' cis, cis' d, d'
  \repeat tremolo 6 {dis, dis'}
  \repeat tremolo 2 {dis, dis'}
  \repeat tremolo 2 {a a'}
  \repeat tremolo 2 {gis, gis'}
  \repeat unfold 8 {\repeat tremolo 6 {e, e'}}
  \repeat unfold 3 {\repeat tremolo 6 {dis, dis'}}
  \repeat tremolo 6 {e, e'}
  \repeat tremolo 6 {fis, fis'}
  \repeat tremolo 6 {g, g'}
  \repeat tremolo 6 {a, a'}
  \repeat tremolo 6 {b, b'}
  \repeat tremolo 6 {c, c'}
  \repeat tremolo 6 {ces, ces'}
  \repeat tremolo 6 {h, h'}
  \repeat tremolo 6 {e,,16-^ e'}
  \repeat unfold 4 {\repeat tremolo 6 {e, e'}}
  ...
  \repeat tremolo 2 {a, a'}
  f, f' e, e' es, es' d, d' des, des' c, c' 
  as8 es16 es' as, as' es es' c c' es, es'
  \clef treble
  as, as' ces, ces'
  \repeat tremolo 2 {es, es'}
  \repeat tremolo 2 {d, d'} ges,8\noBeam
  \clef bass
  ...
  \repeat tremolo 6 {d e}
  \repeat tremolo 6 {d es}
  \repeat tremolo 6 {d e}
  \repeat tremolo 6 {d e}
  ...
  R2.
  \clef bass
  \repeat tremolo 6 {b,,,16-^ b'}
  b, b' a, a' b, b' h, h' c, c' cis, cis'
  \repeat tremolo 2 {d, d'}
  \repeat tremolo 2 {c, c'}
  \repeat tremolo 2 {b, b'}
  \repeat tremolo 2 {a, a'}\repeat tremolo 2 {as, as'}
  \repeat tremolo 2 {g, g'}
  \repeat unfold 2 {\repeat tremolo 6 {fis, fis'}}
  \repeat tremolo 6 {f,-^ f'}
  \repeat unfold 3 {\repeat tremolo 6 {e, e'}}
  e,4-^ r2 <e h' e>2.->\fermata
  \bar "|."
}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%