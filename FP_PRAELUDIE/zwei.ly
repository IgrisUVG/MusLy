...
rechtsZwei = \relative {
  ...
  <<
    {
      g8( c4->~) c8 as8( des4.) c8\noBeam h b
      a4. b8( es4.) ces8( fes4.) es8 d des c4
    }
    \\
    {
      r8 f,4 e g f des es2 a! b4 h f g
    }
  >>
  <as d! es as>2 r4
  <<
    {
      s4
      b'8. fis16 h8 b16 a as->( ces8) b16( c8.) a16
    }
    \\
    {
      h,8.\rest e16~
      e8. d16->~ d c8.->~ c8 d16( f->)~ f des( fes8)
    }
  >>
  <as,! c e as!>4-> r2.
  ...
  b'32 g fis des fis des b g
  \ottava #0
  b g fis des fis des b g
  \stemUp b g fis des fis des
  \change Staff = LH
  b g
  b g fis des! fis des b g
  \stemNeutral
  \change Staff = RH
  f'''' des c a c a g f a g f des f des c a c a g f a g f des
  \stemUp
  f des c
  \change Staff = LH
  a c a g f
...
linksZwei = \relative {
  ...
  \set Staff.ottavation = #"8"
  c,4.-> g'8 <e c'>-> <es b'>4.
  c4.-> g'8 <e c'>-> <es b'>4 fis8
  <b, f'!>4. <a f'>8 <as f'>-> <g f'>4 as8
  c4.-> g'8 <e c'>-> <es b'>4 fis,8
  c'4.-> g'8 <e c'>-> <es b'>4 <g, g'>8
  \ottava #0
  \acciaccatura c8 <c' g' c>4. r8
  <b b'>\noBeam <g g'>-> <c, c'>\noBeam <e! e'!>->~ <e! e'!>2
  \ottava #-1
  \set Staff.ottavation = #"8"
  c,8
  ...
  <c, c'> <as as'> es''8 <b, b'> <ces ces'>4
  fes'8 <ges,, ges'> <heses heses'>4 <b b'> <f f'>8 <e e'>
